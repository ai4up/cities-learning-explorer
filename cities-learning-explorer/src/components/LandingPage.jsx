...
const TYPE_META = {
  "Type 1": {
    ...
    subtitle: "Fast-growing cities with lower economic capacity and infrastructure pressure.",
    bullets: [
  ...
  "Type 2": {
    ...
    subtitle: "Cities balancing growth, infrastructure expansion, and resilience needs.",
    bullets: [
  ...
  "Type 3": {
    ...
    subtitle: "More mature cities with significant planning and adaptation activity.",
    bullets: [
  ...
  "Type 4": {
    ...
    subtitle: "Wealthy or mega-cities with high emissions and complex challenges.",
    bullets: [
...
const LandingPage = () => {
  ...
  useEffect(() => {
    fetch("/cities.json")
      ...
      .then((data) => {
        setCities(data);
        // If Type 1 doesn't exist for some reason, fall back to first type found
      ...
      .catch((err) => console.error("Failed to load cities.json for landing page:", err));
  }, []);
      ...
      <section className="landing-intro">
        <div className="landing-intro-grid">
          <div>
            ...
            <p style={{ fontSize: "0.95rem", color: "#c9d1d9", lineHeight: 1.5 }}>
              Cities play a central role in climate mitigation and adaptation, but case study
              evidence is fragmented and unevenly distributed. Most cities have only a handful
              of documented climate solutions – if any.
            </p>
            <p>
              By building a global typology of cities, we can identify which cities are similar,
              where evidence is concentrated, and how lessons from well-studied cities can inform
          ...
          <div>
            <ul className="landing-bullets">
              ...
              <li>4 data-driven city types derived from 11 urban indicators using Deep Embedded Clustering (DEC).</li>
              <li>100,000+ climate-relevant case studies mapped to cities.</li>
              <li>A framework for evidence-based transfer learning between similar cities and types.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="landing-typology">
        ...
        <div className="typology-left">
          ...
          <div className="typology-intro">
            Scroll through the city types on the left. The charts on the right update
            to show how cities of the selected type compare to all other cities and
            ...
            {TYPE_ORDER.map((t) => {
              ...
              return (
                ...
                >
                  ...
                  <p style={{ fontSize: "0.8rem", marginBottom: "4px", color: "#8b949e" }}>
                    {stats.count.toLocaleString()} cities ·{" "}
                    {stats.regions.length > 0 ? stats.regions.join(" · ") : "—"}
                  </p>
                  {meta?.bullets && (
                    <ul style={{ paddingLeft: "18px", margin: 0, fontSize: "0.84rem" }}>
          ...
          <div className="typology-right-inner">
            <div className="typology-viz-panel">
              <div className="typology-viz-title">
                ...
                <span className="typology-viz-subtitle">
                  Boxplots show all cities (background) and the selected type (colored),
            ...
            <div className="typology-map-panel">
              <div className="typology-viz-title">
                ...
                <span className="typology-viz-subtitle">
                  Cities of the selected type are highlighted. Others are shown in the background.
                </span>
              </div>
